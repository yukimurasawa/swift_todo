...
extension TodoEntity {
    ...
    static func create(in managedObjectCotext: NSManagedObjectContext,category: Category,
                       task: String, time: Date? = Date()){
        let todo = self.init(context: managedObjectCotext)
        print(task)
        todo.time = time
